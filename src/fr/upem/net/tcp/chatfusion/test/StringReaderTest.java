package fr.upem.net.tcp.chatfusion.test;
...
public class StringReaderTest {
    ...
    public void simple() {
        ...
        bb.putInt(bytes.remaining()).put(bytes); //11
    ...
    public void reset() {
        ...
        bb.putInt(bytes.remaining()).put(bytes).putInt(bytes2.remaining()).put(bytes2); //2xx3xxx
        StringReader sr = new StringReader();
        assertEquals(Reader.ProcessStatus.DONE, sr.process(bb));
        assertEquals(string, sr.get());
