...
/**
 * Read a FUSION_INIT_OK request
 */
public class FusionInitOKReader implements Reader<FusionInitOKPacket> {
    ...
    private enum State {
        ...
        /**
         * The byte buffer is expecting to receive a string which
         * represent the source server address
         */
        WAITING_ADDRESS,
        /**
    ...
    private FusionInitOKPacket packet;
    ...
    public ProcessStatus process(ByteBuffer buffer) {
        ...
        packet = new FusionInitOKPacket(serverSrc,
//                new InetSocketAddress(url(address).getHost(), url(address).getPort())
                getAddress(address)
                , members);
     ...
     * the FUSION_INIT_OK format
     * @param buffer    the byte buffer
     * @param nextState the next field expected to be read
     *                  according to FUSION_INIT_OK format
    ...
    /**
     * Get the value of the FUSION_INIT_OK request
     * @return the FUSION_INIT_OK request
     */
    @Override
    public FusionInitOKPacket get() {
        return packet;
    }

    /**
     * Reset the FusionInitOKReader's fields
     */
    @Override
    public void reset() {
